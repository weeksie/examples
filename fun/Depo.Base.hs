-- Oh man. Wow. This is from a document store that I wrote way back
-- in the day. About five years ago we put it on github and forgot
-- about it as it had already lived a long life and died by that point
-- for more insanity, see: https://github.com/snepo/depot
